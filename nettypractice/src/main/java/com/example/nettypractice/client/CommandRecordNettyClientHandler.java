...
public class CommandRecordNettyClientHandler extends ChannelInboundHandlerAdapter {

    private ChannelPromise handshakeFuture;

    private final WebSocketClientHandshaker handShaker;

    public CommandRecordNettyClientHandler(WebSocketClientHandshaker handShaker) {
